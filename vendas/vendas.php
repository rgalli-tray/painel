<h1 class="ls-title-intro ls-ico-cart">Vendas</h1>         
<a href="index.php?pg=nova-venda" class="ls-btn-primary" title="Cadastrar Cliente">Cadastrar Venda</a>            
...
<table class="ls-table">
  ...
  <?php
    ...
    while($listagemVenda = mysql_fetch_array($sqlListagemVenda)) {
      $sqlStatus         = mysql_query('SELECT * FROM status WHERE id='.$listagemVenda['id_status']);
  ...
  ?>
    <tr>
      ...
      <td class="ls-txt-right ls-regroup">
        <a href="index.php?pg=detalhes-venda$id=<?php echo $listagemVenda['id'];?>" class="ls-btn ls-btn-sm">Detalhes</a>
        <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
          <a href="#" class="ls-btn ls-btn-sm"></a>
          <ul class="ls-dropdown-nav">
            <li><a href="index.php?pg=altera-venda&id=<?php echo $listagemVenda['id'];?>">Editar</a></li>
