  ...
  <body>
    ...
    <main class="ls-main">
      <div class="container-fluid">
        ...
        <a href="novo-cliente.php" class="ls-btn-primary" title="Cadastrar Cliente">Cadastrar Cliente</a>            
          ...
          ?>
            ...
            <tr>
              ...
              <td class="ls-txt-right ls-regroup">
                <a href="detalhes-cliente.php?id=<?php echo $listagemCliente['id'];?>" class="ls-btn ls-btn-sm">Detalhes</a>
                <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                  <a href="#" class="ls-btn ls-btn-sm"></a>
                  <ul class="ls-dropdown-nav">
                    <li><a href="altera-cliente.php?id=<?php echo $listagemCliente['id'];?>">Editar</a></li>
