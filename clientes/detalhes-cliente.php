...
<html class="<?php if(!empty($classCorSite)){echo $classCorSite;} else {echo 'ls-theme-blue';}?>">
  ...
  <body>
    ...
    <div class="container-fluid">
      <h1 class="ls-title-intro ls-ico-users">Detalhes Cliente</h1>
      ...
      <?php if($linhaCliente['situacao'] == 1) {
        $status = 'Ativo';
      }else{
        $status = 'Bloqueado';
      }
        ...
        <div class="ls-float-right ls-regroup">
          <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
            ...
            <ul class="ls-dropdown-nav">
              <li><a href="altera-cliente.php?id=<?php echo $linhaCliente['id'];?>">Editar</a></li>
              <li><a href="sql-altera-status-cliente.php?id=<?php echo $linhaCliente['id'];?>">Ativar/Bloquear</a></li>
              <li><a href="sql-deleta-cliente.php?id=<?php echo $linhaCliente['id'];?>" class="ls-color-danger">Excluir</a></li>
            </ul>
          </div>
        </div>
        ...
        <form action="" class="ls-form row" data-ls-module="form">
          <fieldset id="domain-form" class="ls-form-disable ls-form-text">
            <label class="ls-label col-md-6 col-lg-8">
              ...
              <input type="text" value="<?php echo $linhaCliente['nome']; ?>" required>
            </label>
            <label class="ls-label col-md-6 col-lg-8">
              <b class="ls-label-text">E-mail:</b>
              <input type="text" value="<?php echo $linhaCliente['email']; ?>" required>
            </label>
            <label class="ls-label col-md-6 col-lg-8">
            ...
            <label class="ls-label col-md-6 col-lg-8">
              ...
              <input type="text" value="<?php echo converteDataNormal($linhaCliente['data_cadastro']); ?>" required>
            </label>
            <label class="ls-label col-md-6 col-lg-8">
              <b class="ls-label-text">Informações:</b>
              <textarea name="" id="" cols="30" rows="5"><?php echo $linhaCliente['informacoes']; ?></textarea>
            </label>
          </fieldset>
