  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <a href="novo-tipo.php" class="ls-btn-primary">Cadastrar tipo</a>
        ...
        <table class="ls-table">
          ...
          <?php
            $sqlListagemTipo    = mysql_query('SELECT * FROM tipos ORDER BY nome'); /**or die (mysql_error());*/
            while($listagemTipo = mysql_fetch_array($sqlListagemTipo)) {
          ?>

            <tr>
              <td><?php echo $listagemTipo['nome']; ?></td>
              <td class="ls-txt-center hidden-xs"><?php echo $listagemTipo['id_categoria']; ?></td>
              <td class="ls-txt-center hidden-xs"><?php if($listagemTipo['situacao'] == 1) {
                                                          $status = 'Ativo';
                                                        }else{
                                                          $status = 'Bloqueado';
                                                        } echo $status; ?></td>
              <td class="ls-txt-right ls-regroup">
                <a href="detalhes-tipo.php?id=<?php echo $listagemTipo['id']; ?>" class="ls-btn ls-btn-sm">Detalhes</a>
                <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                  <a href="#" class="ls-btn ls-btn-sm"></a>
                  <ul class="ls-dropdown-nav">
                    <li><a href="altera-tipo.php?id=<?php echo $listagemTipo['id']; ?>">Editar</a></li>
                    <li><a href="sql-altera-status-tipo.php?id=<?php echo $listagemTipo['id']; ?>">Ativar/Bloquear</a></li>
                    <li><a href="sql-deleta-tipo.php?id=<?php echo $listagemTipo['id']; ?>" class="ls-color-danger">Excluir</a></li>
                  </ul>
                </div>
              </td>
            </tr>
