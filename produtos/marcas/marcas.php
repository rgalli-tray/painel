  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <a href="nova-marca.php" class="ls-btn-primary">Cadastrar marca</a>
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td class="ls-txt-center hidden-xs"><?php if($listagemMarca['situacao'] == 1) {
                                                          $status = 'Ativo';
                                                        }else{
                                                          $status = 'Bloqueado';
                                                        } echo $status; ?></td>
                <td class="ls-txt-right ls-regroup">
                  <a href="detalhes-marca.php?id=<?php echo $listagemMarca['id']; ?>" class="ls-btn ls-btn-sm">Detalhes</a>
                  <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                    <a href="#" class="ls-btn ls-btn-sm"></a>
                    <ul class="ls-dropdown-nav">
                      <li><a href="altera-marca.php?id=<?php echo $listagemMarca['id']; ?>">Editar</a></li>
