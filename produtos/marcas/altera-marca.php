  ...
  <body>
          ...
          <li><a href="../../produtos/produtos/produtos;php" class="ls-ico-text" role="menuitem">Produtos</a>
            <ul class"ls-submenu" role="menu">
              <li>
                ...
                <a href="marcas.php" class"ls-sub-menu-item" role="menuitem">Marcas</a>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <form id="cad-categoria" name="cad-categoria" method="post" action="sql-altera-marca.php?id=<?php echo $linhaMarca['id'];?>" class="ls-form-horizontal ls-form row">
            ...
            <label class="ls-label col-md-2">
              ...
              <div class="ls-custom-select">
                <select class="ls-custom" name="situacao" required>
                  ...
                  <option value="1" <?php if ($linhaMarca['situacao'] == '1') { echo ' selected="selected"';}?>>Ativo</option>
                  <option value="0" <?php if ($linhaMarca['situacao'] == '0') { echo ' selected="selected"';}?>>Inativo</option>
                </select>
              </div>
            </label>
          </div>
          ...
          <a href="marcas.php" class="ls-btn">Cancelar</a>
        </form>
      </div>
