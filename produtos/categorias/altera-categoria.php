  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <form id="cad-categoria" name="cad-categoria" method="post" action="sql-altera-categoria.php?id=<?php echo $linhaCategoria['id'];?>" class="ls-form-horizontal ls-form row">
            ...
            <label class="ls-label col-md-2">
              ...
              <div class="ls-custom-select">
                <select class="ls-custom" name="situacao" required>
                  ...
                  <option value="1" <?php if ($linhaCategoria['situacao'] == '1') { echo ' selected="selected"';}?>>Ativo</option>
                  <option value="0" <?php if ($linhaCategoria['situacao'] == '0') { echo ' selected="selected"';}?>>Bloqueado</option>
                </select>
              </div>
            </label>
          </div>
