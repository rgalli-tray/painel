  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <a href="novo-fornecedor.php" class="ls-btn-primary">Cadastrar fornecedor</a>
        ...
        <table class="ls-table">
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                <td><?php echo $listagemFornecedor['codigo'];?></td>
                <td><?php echo $listagemFornecedor['razao_social'];?></td>
                <td class="ls-txt-center hidden-xs"><?php echo $listagemFornecedor['nome_fantasia'];?></td>
                <td class="ls-txt-center hidden-xs"><?php if($listagemFornecedor['situacao'] == 1) {
                                                          $status = 'Ativo';
                                                        }else{
                                                          $status = 'Bloqueado';
                                                        } echo $status; ?></td>
                <td class="ls-txt-right ls-regroup">
                  <a href="detalhes-fornecedor.php?id=<?php echo $listagemFornecedor['id']; ?>" class="ls-btn ls-btn-sm">Detalhes</a>
                  <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                    <a href="#" class="ls-btn ls-btn-sm"></a>
                    <ul class="ls-dropdown-nav">
                      <li><a href="altera-fornecedor.php?id=<?php echo $listagemFornecedor['id']; ?>">Editar</a></li>
                      <li><a href="sql-altera-status-fornecedor.php?id=<?php echo $listagemFornecedor['id']; ?>">Ativar/Bloquear</a></li>
                      <li><a href="sql-deleta-fornecedor.php?id=<?php echo $listagemFornecedor['id']; ?>" class="ls-color-danger">Excluir</a></li>
                    </ul>
                  </div>
                </td>
              </tr>   
